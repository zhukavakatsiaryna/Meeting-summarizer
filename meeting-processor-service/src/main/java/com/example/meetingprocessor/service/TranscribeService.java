...
public class TranscribeService {
    ...
    /**
     * Starts a Transcribe job and returns immediately. AWS Transcribe will publish
     * a completion notification to the configured SNS topic when done.
     */
    ...
    /**
     * Downloads and parses the transcript from S3 after job completion.
     * The output S3 location is retrieved from the Transcribe job response.
     */
    ...
    private String[] parseS3Url(String s3Url) {
        // handles both s3://bucket/key and https://s3.amazonaws.com/bucket/key
        ...
        // HTTPS form: https://bucket.s3.amazonaws.com/key or https://s3.amazonaws.com/bucket/key
